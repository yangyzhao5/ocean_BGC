...
! Namelist Options
  ...
  type bacteria
    ...
    real, ALLOCATABLE, dimension(:,:,:) ::      temp_lim         !< Temperature limitation
    real, ALLOCATABLE, dimension(:,:,:) ::      no3lim           !< limitation due to nitrate ! YZ: 07/07/2025
  ...
  type generic_COBALT_type
     ...
     real  ::          &
          ...
          alpha_n2o,        & ! scalar multiplier for N2O prod., O2 dependency  ! YZ: N2O_module 13/06/2025 {
          beta_n2o,         & ! scalar multiplier for N2O prod.
          o2_max_denit,     & ! max. O2 conc. for denitrification
          k_o2_denit1,      & ! O2 poisoning for nitrate reduction to N2O
          k_o2_denit2,      & ! O2 poisoning for N2O reduction to N2
          k_n2o_denit,      & ! half-inhibition constant for N2O consumption
          n2o_2_n_sed,      & ! scalar multiplier for N2O production by sedimentary denitrification
     ...
     real    :: a_1_n2o, a_2_n2o, a_3_n2o, b_1_n2o, b_2_n2o, b_3_n2o     ! YZ: N2O_module 13/06/2025 {
     real    :: a1_n2o, a2_n2o, a3_n2o, a4_n2o, a5_n2o                   ! } YZ
...
! << Add neritic CaCO3 burial >>
          ...
          tot_layer_int_poc,&
          tot_layer_int_dic,& 
          f_n2o,&             ! YZ: N2O_module, 13/06/2025 {
          f_n2o_nit,&
          f_n2o_denit,&
          f_n2o_atm,&
          f_n2o_sed,&
          ...
          jsink_n2o_sed,&
          tot_layer_int_n2o,&
          tot_layer_int_n2o_nit,&
          tot_layer_int_n2o_denit,&
          tot_layer_int_n2o_atm,&
          tot_layer_int_n2o_sed,&
          jremin_ndet_denit1,&
          jremin_ndet_denit2,&
          jremin_ndet_denit0,&   ! } YZ
          f_n2o_apht,&           ! YZ: N2O_apht, 13/12/2025 {
          jn2o_apht,&
          jn2o_apht_plus_btm,&
          jprod_n2o_apht_nit,&
          jsink_n2o_apht,&
          tot_layer_int_n2o_apht,& ! } YZ
...
!==============================================================================================================
     ...
     real, dimension(:,:), ALLOCATABLE :: &
          ...
          n2o_nit_alpha,n2o_denit_alpha,n2o_atm_alpha,n2o_sed_alpha,&
          n2o_nit_csurf,n2o_denit_csurf,n2o_atm_csurf,n2o_sed_csurf,& 
          b_n2o_apht,n2o_apht_alpha,n2o_apht_csurf,&   ! YZ: N2O_apht, 13/12/2025
...
! JGJ 2016/08/08 CMIP6 Ocnbgc
          ...
          btm_n2o,&                    ! YZ: N2O_module, 13/06/2025 {
          btm_n2o_nit,&
          btm_n2o_denit,&
          btm_n2o_atm,&
          btm_n2o_sed,&
          ...
          wc_vert_int_n2o_apht,&       ! YZ: N2O_apht, 13/12/2025 {
          wc_vert_int_jn2o_apht,&
          wc_vert_int_jprod_n2o_apht_nit,&
          wc_vert_int_jsink_n2o_apht,& ! } YZ
...
!==============================================================================================================
     ...
     real, dimension(:,:,:,:), pointer :: &
          ...
          p_po4,&
          p_n2o,&       ! YZ: N2O_module, 13/06/2025 {
          p_n2o_nit,&
          p_n2o_denit,&
          p_n2o_atm,&
          p_n2o_sed,&   ! } YZ
          p_n2o_apht,&  ! YZ: N2O_apht, 13/12/2025
      ...
      real, dimension (:,:), allocatable :: &
          ...
          deltap_dic,&
          deltap_o2,&
          stf_gas_n2o,&  ! YZ: N2O_module, 13/06/2025 {
          stf_gas_n2o_nit,&
          stf_gas_n2o_denit,&
          stf_gas_n2o_atm,&
          stf_gas_n2o_sed,&
          ...
          deltap_n2o_atm,&
          deltap_n2o_sed,&  ! } YZ
          stf_gas_n2o_apht,& ! YZ: N2O_apht, 13/12/2025 {
          deltap_n2o_apht,&  ! } YZ
...
! << Add neritic CaCO3 burial >>
          ...
          id_jpo4_100       = -1,      &
          id_jsio4_100      = -1,      &
          id_jn2o           = -1,      & ! YZ: N2O_module,13/06/2025 {
          id_jn2o_nit       = -1,      &
          id_jn2o_denit     = -1,      &
          id_jn2o_atm       = -1,      &
          id_jn2o_sed       = -1,      &
          id_jn2o_plus_btm      = -1,  &
          id_jn2o_nit_plus_btm  = -1,  &
          id_jn2o_denit_plus_btm= -1,  &
          id_jn2o_atm_plus_btm  = -1,  &
          id_jn2o_sed_plus_btm  = -1,  &
          id_jprod_n2o_nit  = -1,      &
          id_jprod_n2o_denit= -1,      &
          id_jsink_n2o      = -1,      &
          id_jsink_n2o_nit  = -1,      &
          id_jsink_n2o_denit= -1,      &
          id_jsink_n2o_atm  = -1,      &
          id_jsink_n2o_sed  = -1,      &
          id_n2osat         = -1,      &
          id_n2o_alpha      = -1,      &
          ...
          id_dpn2o_atm      = -1,      &
          id_dpn2o_sed      = -1,      &
          id_wc_vert_int_n2o            = -1, &
          id_wc_vert_int_n2o_nit        = -1, &
          ...
          id_wc_vert_int_jsink_n2o_nit  = -1, &
          id_wc_vert_int_jsink_n2o_denit= -1, &
          id_wc_vert_int_jsink_n2o_atm  = -1, &
          id_wc_vert_int_jsink_n2o_sed  = -1, &
          id_tot_layer_int_n2o          = -1, &
          id_tot_layer_int_n2o_nit      = -1, &
          ...
          id_jn2o_apht                  = -1, &  ! YZ: N2O_apht, 13/12/2025 {
          id_jn2o_apht_plus_btm         = -1, &
          id_jprod_n2o_apht_nit         = -1, &
          id_jsink_n2o_apht             = -1, &
          id_sfc_n2o_apht               = -1, &
          id_b_n2o_apht                 = -1, &
          id_fgn2o_apht                 = -1, &
          id_dpn2o_apht                 = -1, &
          id_wc_vert_int_n2o_apht       = -1, &
          id_wc_vert_int_jn2o_apht      = -1, &
          id_wc_vert_int_jprod_n2o_apht_nit   = -1, &
          id_wc_vert_int_jsink_n2o_apht = -1, &
          id_tot_layer_int_n2o_apht     = -1, &  ! } YZ
